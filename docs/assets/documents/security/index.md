...
The general and specific security about this is described in: <a href="./media/Sikkerhedsarkitektur EHMI services v10.pdf" target="_blank">Sikkerhedsarkitektur EHMI services v1.0/Security architechture regarding EHMI central services v 0.98 (opens in new window)</a>
