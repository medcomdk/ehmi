...
|---                               |---          |---          |---          |
|<i>**EHMI Server & API Security**</i> <br/> <br/> <br/> <br/> | EHMI API Security for: <br/> - EDS <br/> EDS Security is handled as described in: <br/> <a href="../security/media/Sikkerhedsarkitektur EHMI services v10.pdf" target="_blank">Sikkerhedsarkitektur EHMI services v1.0 (opens in new window)</a> <br/> | EHMI Server & API Security for: <br/> - EDS <br/> - EAS <br/> - EER|Tenders for: <br/> - EHMI Security Server <br/> <br/> <br/> |
|---                               |---          |---          |---          |
